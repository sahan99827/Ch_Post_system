...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (products.length === 0) {
        products = [
            { id: 1, name: 'Basic T-Shirt', type: 'tops', price: 1500, image: 'accest/img/cl1.png' },
            { id: 2, name: 'Polo Shirt', type: 'tops', price: 2500, image: 'accest/img/cl2.png' },
            { id: 3, name: 'Jeans', type: 'bottoms', price: 3500, image: 'accest/img/cl3.png' },
            { id: 4, name: 'Shorts', type: 'bottoms', price: 2000, image: 'accest/img/cl4.png' },
            { id: 5, name: 'Summer Dress', type: 'dresses', price: 4500, image: 'accest/img/cl5.png' },
            { id: 6, name: 'Sunglasses', type: 'accessories', price: 1200, image: 'accest/img/cl6.png' },
            { id: 7, name: 'Belt', type: 'accessories', price: 800, image: 'accest/img/cl7.png' },
            { id: 8, name: 'Hat', type: 'accessories', price: 1000, image: 'accest/img/cl8.png' }
        ];
...
function displayProducts(category = 'all', searchTerm = '') {
    ...
    if (filteredProducts.length === 0) {
        productsGrid.innerHTML = '<div class="col-12 text-center text-muted py-5"><i class="fas fa-box-open fa-3x mb-3"></i><p>No products found</p></div>';
        return;
    }
...
document.querySelectorAll('.category-tab').forEach(tab => {
    tab.addEventListener('click', function() {
        ...
        displayProducts(currentCategory, document.getElementById('searchProduct').value);
    });
});
...
document.querySelectorAll('.sidebar-icon[data-view]').forEach(icon => {
    icon.addEventListener('click', function() {
        ...
        document.querySelectorAll('.category-tab').forEach(t => t.classList.remove('active'));
        document.querySelector(`.category-tab[data-category="${view}"]`).classList.add('active');
